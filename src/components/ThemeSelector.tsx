...
export function ThemeSelector({ className = '' }: ThemeSelectorProps) {
  const { currentTheme, availableThemes, setTheme, searchThemes, isLoading } = useTheme();
  ...
  return (
    <div className={`relative ${className}`}>
      <Button variant="outline" onClick={() => setIsOpen(!isOpen)} disabled={isLoading}>
      ...
      <Dialog toggleModal={isOpen} setToggleModal={setIsOpen}>
        {/* Header */}
            ...
            {filteredThemes.map(theme => (
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <p className="line-clamp-2 text-xs text-gray-600">{theme.config.description}</p>
