...
export function LoadingOverlay({ 
  ...
  return (
    <div className={`fixed inset-0 z-50 flex items-center justify-center bg-white/80 backdrop-blur-sm transition-all duration-300 ${className}`}>
      <div className="rounded-xl bg-white p-6 shadow-2xl border border-gray-200">
